function add_university_form(){
    ...
    document.getElementById("add_university").children[1].children[0].children[2].children[1].children[3].innerHTML = "Oras...";
    document.getElementById("add_university").children[1].children[0].children[2].children[1].children[3].classList.add("default");
